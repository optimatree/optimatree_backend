...
class AuthToken(models.Model):
    ...
    token = models.CharField(_("Token"), max_length=token_length, primary_key=True, db_index=True)
    refresh_token = models.CharField(_("Refresh_token"), max_length=token_length, unique=True, db_index=True)
